...
<html lang="en">
	<head><base href=""/>
		<title>Machinery and Equipment - User Performance Report</title>
		<meta charset="utf-8" />
	...
	<body ng-app="UserPerf" ng-controller="UserPerfCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">User Performance Report</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="card" style="box-shadow: 0 4px 8px 0 rgb(0,0,0,0.2); padding: 10px;">
										<div class="card-body py-4">
											<div class="table-responsive">
												<form class="form" autocomplete="off" name="formHolder.UserPerfs">
													<div class="card-body">
														<div class="row mb-6">

															<div class="row pt-5">
																<div class="col-lg-6">
																	<label class="form-label">From<label class="text-danger">*</label></label>
                                                                    <input type="date" name="from_date" class="form-control form-control-lg" ng-disabled="controls.ok.btn" ng-model="UserPerfs.from_date" ng-class="{'is-invalid': formHolder.UserPerfs.from_date.$touched && formHolder.UserPerfs.from_date.$invalid}" required/>
																</div>
																<div class="col-lg-6">
																	<label class="form-label">To<label class="text-danger">*</label></label>
                                                                    <input type="date" name="to_date" class="form-control form-control-lg" ng-disabled="controls.ok.btn" ng-model="UserPerfs.to_date" ng-class="{'is-invalid': formHolder.UserPerfs.to_date.$touched && formHolder.UserPerfs.to_date.$invalid}" required/>
																</div>
															</div>
		...
		<script src="modules/report-UserPerformance.js?ver=1.0.0.0"></script>
		<script src="controllers/report-UserPerformance.js?ver=1.0.0.0"></script>
	</body>
</html>