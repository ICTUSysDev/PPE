<?php 
$page = "report_machinery_equipment";
$dropdown = "reports";
$ppe_dropdown = "ppe";
?>
...
<html lang="en">
	<head><base href=""/>
		<title>Report on Machinery and Equipment</title>
		<meta charset="utf-8" />
	...
	<body ng-app="user" ng-controller="userCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<a href="#" ng-click="app.user(this)" ng-show="showAddButton" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Add User</a>
		...
		<script src="modules/user.js?ver=1.0.0.0"></script>
		<script src="controllers/user.js?ver=1.0.0.0"></script>
	</body>
</html>