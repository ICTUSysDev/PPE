...
<html lang="en">
	<head><base href=""/>
		<title>Machinery and Equipment - Physical Count of Equipment, Furnitures and Fixtures and Other PPE</title>
		<meta charset="utf-8" />
	...
	<body ng-app="PCEFFOPPE" ng-controller="PCEFFOPPECtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Machinery and Equipment - Physical Count of Equipment, Furnitures and Fixtures and Other PPE</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="card" style="box-shadow: 0 4px 8px 0 rgb(0,0,0,0.2); padding: 10px;">
										<div class="card-body py-4">
											<div class="table-responsive">
												<form class="form" autocomplete="off" name="formHolder.PCEFFOPPEs">
													<div class="card-body">
														<div class="row mb-6">
															<div class="row">
																<div class="col-lg-6">
																	<label class="form-label">Equipment Type<label class="text-danger">*</label></label>
																	<select name="equipment_type" aria-label="Select Equipment Type" data-control="select2" data-placeholder="Select Equipment Type..." class="select2-width-75 form-select" ng-disabled="controls.ok.btn" ng-change="app.checkEquipmentType(this)" ng-model="PCEFFOPPEs.equipment_type" ng-class="{'is-invalid': formHolder.PCEFFOPPEs.equipment_type.$touched && formHolder.PCEFFOPPEs.equipment_type.$invalid}" required>
																		<option value="">Select Charts of Account...</option>
																		<option value="MACHINERY AND EQUIPMENT">Machinery Equipment/Furniture and Fixtures</option>
																		<option value="BUILDING AND OTHER STRUCTURES">Building and Structures</option>
																		<option value="INFRASTRUCTURE ASSET">Infrastructure Assets</option>
															...
															<div class="row pt-5">
																<div class="col-lg-6">
																	...
																	<select name="fund" aria-label="Select Fund" data-control="select2" data-placeholder="Select Fund..." class="select2-width-75 form-select" ng-disabled="disableFund" ng-change="app.checkFund(this)" ng-options="f.code + ' - ' + (f.name) + ' ' for f in PCEFFOPPEs.funds track by f.id" ng-model="PCEFFOPPEs.fund">
																		<option value="" disabled>Select Fund...</option>
																	</select>
																</div>
																<div class="col-lg-6">
																	<label class="form-label">Year<label class="text-danger">*</label></label>
																	<select name="year" aria-label="Select Year" data-control="select2" data-placeholder="Select Year..." class="select2-width-75 form-select" ng-disabled="controls.ok.btn" ng-change="app.checkYear(this)" ng-options="y.year for y in PCEFFOPPEs.years track by y.year" ng-model="PCEFFOPPEs.year" ng-class="{'is-invalid': formHolder.PCEFFOPPEs.year.$touched && formHolder.PCEFFOPPEs.year.$invalid}" required>
																		<option value="" disabled>Select Year...</option>
																	</select>
																</div>
															</div>
															<div class="row me-2 pt-5">
																<div class="col-lg-12 d-flex justify-content-end"><br>
																	<button type="submit" class="btn btn-primary" id="spinner_form_submit" ng-click="app.genReport(this)" ng-disabled="disableButtonReport">
		...
		<script src="modules/report-PCEFFOPPE.js?ver=1.0.0.0"></script>
		<script src="controllers/report-PCEFFOPPE.js?ver=1.0.0.0"></script>
	</body>
</html>