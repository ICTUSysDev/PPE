    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'>Upload your Files</span>
          <button type="button" class="btn btn-primary">Select file to upload</button>
        </div>
      </div>
      `);
      ...
      const readingFile = (id, file) => {
        ...
        let container = $(`<div class='imageuploadify-container'>
          <a type='button'><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <rect x="0" y="0" width="24" height="24"/>
            <circle fill="#e3dede" opacity="0.5" cx="12" cy="12" r="10"/>
        ...
        let deleteBtn = container.find("a");
        ...
        if (file.type && file.type.search(/image/) != -1) {
          ...
          // If the file is an video file, replace the icon by an video file icon.
            ...
            let image = $("<img>");
            // Paste the image source to display the image preview.
            image.attr("src", './assets/files/icons/pdf.png');
      ...
      const disableMouseEvents = () => {
        ...
        dragbox.css("border-color", "#50cd89");
