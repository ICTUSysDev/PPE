...
<html lang="en">
	<head><base href=""/>
		<title>Machinery and Equipment PAR</title>
		<meta charset="utf-8" />
	...
	<body ng-app="machineryEquipmentPar" ng-controller="machineryEquipmentParCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Machinery and Equipment PAR list</li>
										</ul>
									</div>
		...
		<script src="modules/machinery-equipment-par.js?ver=1.0.0.0"></script>
		<script src="controllers/machinery-equipment-par.js?ver=1.0.0.0"></script>
	</body>
</html>