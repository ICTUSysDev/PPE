    ...
    // List Start
		...
		function print(scope) {
			...
			var doc = new jsPDF('p','mm',[215.9,279]);
				...
				doc.text(62.265,lastRowCoord+35,scope.data.approved_by.position.toUpperCase(),'center');
				...
				doc.text(119.80,lastRowCoord+35,scope.data.signatory.position.toUpperCase(),'center');
				...
				doc.text(175.33,lastRowCoord+35,scope.data.accountable_officer.position.position_description.toUpperCase(),'center');
				...
				doc.setFontSize(6);
				doc.text(12.7, 274, 'Report generated by ' + scope.data['userFullName'] + ' at ' + scope.data['reportDate'],'left');
