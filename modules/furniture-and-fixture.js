angular.module('app-module',['notify', 'my-pagination','ui.bootstrap','bootstrap-modal','bootstrap-growl','block-ui','notify','form-validator', 'module-access']).factory('app', function($compile,$timeout,$http,bootstrapModal,growl,validate,bui,myPagination,notify, access) {
    ...
    var self = this;
		...
		self.data = function(scope) {
			...
			scope.headerName = "Furniture and Fixture";

			// for Validation
			scope.formHolder = {};

			// CRUD
			scope.furnitureAndFixture = {}
			scope.furnitureAndFixture.id = 0;

			// List
			scope.furnitureAndFixtures = [];
    ...
    // List Start
		self.list = function(scope) {
			...
			scope.controls.edit.label = "Edit";
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/list.php',
					data: scope.furnitureAndFixtures
				}).then(function mySucces(response) {
					
					scope.furnitureAndFixtures = angular.copy(response.data);
					
				}, function myError(response) {

				});

				$('#content').load('lists/furniture-and-fixtures.html', function() {
		...
		function semiExpandablelist(scope) {
			...
			scope.controls.edit.label = "Edit";
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/semi-expandable-list.php',
				}).then(function mySucces(response) {
					
					scope.furnitureAndFixturesSemiExpandable = angular.copy(response.data);
		...
		// Form Start
		self.furnitureAndFixture = function(scope,row) {
			...
			$('#content').load('forms/furniture-and-fixture.html',function() {
				$timeout(function() { $compile($('#content')[0])(scope); },300);
			});
			...
			if (row != null) {
				...
				$http({
				  method: 'POST',
				  url: 'handlers/furniture-and-fixtures/view.php',
				  data: {id: row.id}
				}).then(function mySucces(response) {
					
					angular.copy(response.data, scope.furnitureAndFixture);

					if (response.data.acquisition_date != null){scope.furnitureAndFixture.acquisition_date = new Date(response.data.acquisition_date);}else{};

					self.filterArticle(scope,response.data.article_id);
					self.filterBrand(scope,response.data.article_id.id);
					self.fileList(scope,scope.furnitureAndFixture.id);
		...
		self.save = function(scope) {
			...
			if (validate.form(scope,'furnitureAndFixture')){ 
			...
			var onOk = function() {
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/save.php',
					data: {furnitureAndFixture: scope.furnitureAndFixture}
				}).then(function mySuccess(response) {
					
						if(scope.furnitureAndFixture.id==0){
							scope.furnitureAndFixture.id = response.data;
						}
		...
		self.delete = function(scope,row) {
			...
			var onOk = function() {
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/delete.php',
					data: {id: [row.id]}
				}).then(function mySucces(response) {
		...
		self.filterArticle = function(scope,item) {
			...
			$http({
			  method: 'POST',
			  url: 'handlers/furniture-and-fixtures/filter-articles.php',
		...
		self.filterBrand = function(scope,item_id) {

			$http({
			  method: 'POST',
			  url: 'handlers/furniture-and-fixtures/filter-brands.php',
		...
		function locations(scope) {
			...
			$http({
			  method: 'POST',
			  url: 'handlers/furniture-and-fixtures/locations.php',
			}).then(function mySucces(response) {
		...
		self.filterOfficer = function(scope, item) {
			...
			$http({
				method: 'POST',
				url: 'handlers/furniture-and-fixtures/filter-officer.php',
				data: {officeId: item}
			}).then(function mySuccess(response) {
		...
		self.assignedTo = function(scope,row) {
			...
			mode(scope, row);
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/view-assign.php',
					data: {id: row.id}
				}).then(function mySucces(response) {
					...
					if(response.data==null) {
						...
						self.filterOfficer(scope, scope.assignTo.office.id);
		...
		self.assignTo = function(scope) {
			...
			if(scope.furnitureAndFixture.id==0) {
				growl.show('alert alert-danger',{from: 'top', amount: 55},'Please add or save Furniture, Fixtures or Books first!');
				return;
			}

			if(scope.furnitureAndFixture.status=='Not Available') {
				growl.show('alert alert-danger',{from: 'top', amount: 55},'This Equipment is already assigned!');
				return;
			}

			if(scope.furnitureAndFixture.status=='DISPOSED') {
			...
			var spinner;
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/assign-to.php',
					data: {assignTo: scope.assignTo, furnitureAndFixture: scope.furnitureAndFixture}
				}).then(function mySuccess(response) {
					...
					setTimeout(function() {
							...
							Swal.fire({
								...
								if (result.isConfirmed) {
									...
									if(scope.furnitureAndFixture.carrying_amount >= 50000) {
      ...
      $('#uploadFile').click(function() {
				...
				$.ajax({
						url: 'handlers/furniture-and-fixtures/upload-files.php',
						type: 'POST',
						data: formData,
						dataType: 'json',
						processData: false,
						...
						success: function(response) {
							...
							scope.furnitureAndFixture.fileNames = response;
				...
				setTimeout(function() {
					...
					var moduleName = 'FURNITURE AND FIXTURE';

					var onOk = function() {
						$http({
							method: 'POST',
							url: 'handlers/file-uploads/save-file-names.php',
							data: {fileNames: scope.furnitureAndFixture.fileNames, landId: scope.furnitureAndFixture.id, module_name: moduleName}
						}).then(function mySucces(response) {
		...
		self.downloadFile = function(scope, itemId) {
			...
			var fileUrl = './assets/files/furniture-and-fixtures/';
		...
		self.deleteFile = function(scope,item) {
			...
			self.printPropSticker = function(details) {
				...
				new QRCode("qr_code", {
					text: "http://ppe.launion.gov.ph/qr-machinery-furniture-physical-count.php?type=%27Furniture%20and%20Fixture%27&id=" + details.ff.id,
					width: 75,
					height: 75,
					colorDark : "#000000",
					colorLight : "#ffffff",
				...
				$http({
					method: 'POST',
					url: 'handlers/furniture-and-fixtures/propertySticker.php',
					data: {ppe_id: details.ff.id}
				  }).then(function mySucces(response) {
	...
	var logo = "data:image/png;base64,";
		...
		let convertToText = list.property_number;
		let furniturePropNumber = convertToText.toString();
	
		if ((doc.getStringUnitWidth(furniturePropNumber) * 10)/2.8125 > 64 ) 
		{
			
			for (let fontSize=10; fontSize>4;fontSize-- )
			{
				
				if ((doc.getStringUnitWidth(furniturePropNumber) * fontSize)/2.8125 < 64)
				{
					doc.setFontSize(fontSize);
					doc.text(30, 33,  furniturePropNumber,({maxWidth: 0, align:	'left',}));
					break;
				}
			}
		}
