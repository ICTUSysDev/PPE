...
<html lang="en">
	<head><base href=""/>
		...
		<link href="https://unpkg.com/filepond@4.25.0/dist/filepond.css" rel="stylesheet">
    <script src="https://unpkg.com/filepond@4.25.0/dist/filepond.js"></script>
	...
	<body ng-app="land" ng-controller="landCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Land list</li>
										</ul>
									</div>
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<a href="#" ng-click="app.land(this)" ng-show="showAddButton" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Add</a>
		...
		<script src="assets/js/imageuploadify.js?ver=1.0.0.6"></script>
		<!-- mapping -->
		...
		<script src="modules/land.js?ver=1.0.0.0"></script>
		<script src="controllers/land.js?ver=1.0.0.0"></script>
	</body>
</html>