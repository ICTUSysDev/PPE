...
<html lang="en">
	...
	<body ng-app="brand" ng-controller="brandCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Brand list</li>
										</ul>
									</div>
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<a href="#" ng-click="app.brand(this)" ng-show="showAddButton" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Add</a>
		...
		<script src="modules/brand.js?ver=1.0.0.0"></script>
		<script src="controllers/brand.js?ver=1.0.0.0"></script>
	</body>
</html>