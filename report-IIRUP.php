...
<html lang="en">
	<head><base href=""/>
		<title>Machinery and Equipment - IIRUP Report</title>
		<meta charset="utf-8" />
	...
	<body ng-app="reportIIRUP" ng-controller="reportIIRUPCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Machinery and Equipment - Inventory and Inspection of Unserviceable Property Report (IIRUP)</li>
										</ul>
									</div>
											...
											<div class="card-body pt-2">
												<div class="row mb-6">
													<div class="col-lg-6 fv-row">
														...
														<!-- <input type="text" id="datepicker" class="form-control form-control-lg" ng-model="filter.year" required/> -->
														<input type="date" id="datepicker"  class="form-control form-control-lg" placeholder="Date"  ng-model="filter.start"  required/>
													</div>
													<div class="col-lg-6 fv-row">
														<!-- <label class="form-label fs-6 fw-semibold">Year</label> -->
														<label class="form-label">To<label class="text-danger">*</label></label>
														<!-- <input type="text" id="datepicker" class="form-control form-control-lg" ng-model="filter.year" required/> -->
														<input type="date" id="datepicker"  class="form-control form-control-lg" placeholder="Date"  ng-model="filter.end"  required/>
													</div>
												...
												<div class="d-flex justify-content-end">
														<button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter" ng-click="app.generateReport(this)">Generate</button>
													</div>
		...
		<script src="modules/report-IIRUP.js?ver=1.0.0.0"></script>
		<script src="controllers/report-IIRUP.js?ver=1.0.0.0"></script>
	</body>
</html>