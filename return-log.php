...
<html lang="en">
	...
	<body ng-app="returnLog" ng-controller="returnLogCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
							...
							<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
								<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
										...
										<li class="breadcrumb-item text-muted">Return log</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div id="kt_app_content" class="app-content flex-column-fluid">
						<div id="kt_app_content_container" class="app-container container-fluid">
							<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#property_report_report">Property Return Report</a>
								</li>
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#disposal_tab">Disposed</a>
								</li>
								<!-- <li class="nav-item">
									<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#repair_tab">Repair/Repaired</a>
								</li> -->
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#return_to_stock_tab">Returned to Stock</a>
								</li>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="property_report_report" role="tabpanel">
													...
													<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
														...
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															...
															<div class="d-flex justify-content-end">
																<button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter" ng-click="app.filterLog(this)">Apply</button>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="card-body">
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr ng-repeat="rl in filterData = (returnLogs | filter:searchReturn) | pagination: currentPage:pageSize">
														<td><strong>{{ rl.list_no }}</strong></td>
														<td class="d-flex align-items-center">
															<div class="fw-semibold ms-5">
																<a href="#" class="fs-5 fw-bold text-dark text-hover-primary">{{ rl.accountable_officer.accountable_officer }}</a>
																<div class="fs-7 text-muted">Par No.:
																<a href="#">{{ rl.par_no }}</a></div>
															</div>
														</td>
														<td>{{ rl.office_id.name }}</td>
														<td>
															<div class="badge badge-light-success fw-bold">{{ rl.par_machinery_equipment.status }}</div>
														</td>
														<td>{{ rl.par_date }}</td>
														<td class="text-end">
															<a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3" ng-click="app.viewReport(this, rl)">
								...
								<div class="tab-pane fade" id="disposal_tab" role="tabpanel">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
														...
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															...
															<div class="d-flex justify-content-end">
																<button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter" ng-click="app.returnLog(this)">Apply</button>
															</div>
														</div>
													</div>
													<button type="button" class="btn btn-light-primary me-3" ng-click="app.exportDisposal(this)">
													<span class="svg-icon svg-icon-2">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="card-body">
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
													<th><strong>#</strong></th>
														<th><strong>From PAR #</strong></th>
														<th><strong>Returned to</strong></th>
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr ng-repeat="tl in filterDataDL = (returnLogsMasterlist.disposal_equipment | filter:searchtransferLogs) | pagination: currentPageDL:pageSizeDL">
														<td><strong>{{ tl.list_no }}</strong></td>
														<td class="d-flex align-items-center">
															<div>PAR No.:
																	<a href="#">{{ tl.par_details.par_no }}</a>
															</div>
														</td>
														<td>{{ tl.accountable_officer.name }}</td>
														<td>{{ tl.article_id.name }}</td>
														<td>{{ tl.disposal_equipment.property_number }}</td>
														<td>
								...
								<div class="tab-pane fade" id="repair_tab" role="tabpanel">
									<div class="card pt-4 mb-6 mb-xl-9" style="box-shadow: 0 4px 8px 0 rgb(0,0,0,0.2); padding: 10px;">
										<div class="card-header border-0">
											<div class="card-title">
												<div class="d-flex align-items-center position-relative my-1">
											...
											<div class="card-toolbar">
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<button type="button" class="btn btn-light-primary me-3" ng-click="app.exportRepair(this)">
													<span class="svg-icon svg-icon-2">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
															<path d="M12.0573 6.11875L13.5203 7.87435C13.9121 8.34457 14.6232 8.37683 15.056 7.94401C15.4457 7.5543 15.4641 6.92836 15.0979 6.51643L12.4974 3.59084C12.0996 3.14332 11.4004 3.14332 11.0026 3.59084L8.40206 6.51643C8.0359 6.92836 8.0543 7.5543 8.44401 7.94401C8.87683 8.37683 9.58785 8.34458 9.9797 7.87435L11.4427 6.11875C11.6026 5.92684 11.8974 5.92684 12.0573 6.11875Z" fill="currentColor" />
										...
										<div class="card-body">
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr ng-repeat="rl in filterDataDL = (returnLogsMasterlist.repair_equipment | filter:searchtransferLogs) | pagination: currentPageDL:pageSizeDL">
														<td><strong>{{ rl.list_no }}</strong></td>
														<td class="d-flex align-items-center">
															<div>PTR No.:
																	<a href="#">{{ rl.par_details.par_no }}</a>
															</div>
														</td>
														<td>{{ rl.accountable_officer.name }}</td>
														<td>{{ rl.article_id.name }}</td>
														<td>{{ rl.repair_equipment.property_number }}</td>
														<td>
								...
								<div class="tab-pane fade" id="return_to_stock_tab" role="tabpanel">
									<div class="card pt-4 mb-6 mb-xl-9" style="box-shadow: 0 4px 8px 0 rgb(0,0,0,0.2); padding: 10px;">
										<div class="card-header border-0">
											<div class="card-title">
												<div class="d-flex align-items-center position-relative my-1">
											...
											<div class="card-toolbar">
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<button type="button" class="btn btn-light-primary me-3" ng-click="app.exportReturnToStock(this)">
													<span class="svg-icon svg-icon-2">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
															<path d="M12.0573 6.11875L13.5203 7.87435C13.9121 8.34457 14.6232 8.37683 15.056 7.94401C15.4457 7.5543 15.4641 6.92836 15.0979 6.51643L12.4974 3.59084C12.0996 3.14332 11.4004 3.14332 11.0026 3.59084L8.40206 6.51643C8.0359 6.92836 8.0543 7.5543 8.44401 7.94401C8.87683 8.37683 9.58785 8.34458 9.9797 7.87435L11.4427 6.11875C11.6026 5.92684 11.8974 5.92684 12.0573 6.11875Z" fill="currentColor" />
										...
										<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr ng-repeat="rl in filterDataDL = (returnLogsMasterlist.return_to_stock | filter:searchtransferLogs) | pagination: currentPageDL:pageSizeDL">
														<td><strong>{{ rl.list_no }}</strong></td>
														<td class="d-flex align-items-center">
															<div>PTR No.:
																	<a href="#">{{ rl.par_details.par_no }}</a>
														...
														<td>{{ rl.accountable_officer.name }}</td>
														<td>{{ rl.article_id.name }}</td>
														<td>{{ rl.return_to_stock.property_number }}</td>
														<td>
															<div class="badge badge-light-success fw-bold">{{ rl.par_details.par_date }}</div>
														</td>
													</tr>
		...
		<script src="modules/return-log.js?ver=1.0.0.0"></script>
		<script src="controllers/return-log.js?ver=1.0.0.0"></script>
	</body>
</html>