<?php 
$page = "reportICS";
$nested_dropdown = "reportMachineryAndEquipment";
$ppe_dropdown = "ppe_reports";
$dropdown = "reports";
...
<html lang="en">
	<head><base href=""/>
		<title>Machinery and Equipment - Inventory Custodian Slip (ICS)</title>
		<meta charset="utf-8" />
	...
	<body ng-app="reportICS" ng-controller="reportICSCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<li class="breadcrumb-item text-muted">Machinery and Equipment - Inventory Custodian Slip (ICS)</li>
										</ul>
									</div>
											...
											<div class="table-responsive">
												<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
													...
													<tbody class="text-gray-600 fw-semibold">
														<tr ng-repeat="me in filterData = (ICSs | filter:searchPAR) | pagination: currentPage:pageSize">
															<td><strong>{{ me.list_no }}</strong></td>
															<td class="d-flex align-items-center">
																<div class="fw-semibold ms-5">
																	<a href="#" class="fs-5 fw-bold text-dark text-hover-primary">{{ me.accountable_officer.name }}</a>
																	<div class="fs-7 text-muted">ICS No.:
																	<a href="#">{{ me.par_no }}</a></div>
																</div>
															</td>
															<td>{{ me.accountable_officer.office_id.shortname }}</td>
															<td>
																<div class="badge badge-light fw-bold">{{ me.par_date }}</div>
															</td>
															<td class="text-end">
																<a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3" ng-click="app.viewICS(this, me)">
		...
		<script src="modules/report-ICS.js?ver=1.0.0.0"></script>
		<script src="controllers/report-ICS.js?ver=1.0.0.0"></script>
	</body>
</html>