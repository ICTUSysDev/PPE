...
<html lang="en">
	<head><base href=""/>
		<title>Pre-Repair Inspection</title>
		<meta charset="utf-8" />
	...
	<body ng-app="preRepairInspection" ng-controller="preRepairInspectionCtrl" id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default" account-profile>
					...
					<div id="kt_app_content" class="app-content flex-column-fluid">
						<div id="kt_app_content_container" class="app-container container-fluid">
							<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
								<li class="nav-item">
									<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_view_overview_tab">Pre-Repair Inspection</a>
								</li>
							</ul>
											...
											<div class="card-header pt-7">
												<div class="card-title">
													<div class="d-flex align-items-center position-relative my-1">
														...
														<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search..." ng-model="searchpreRepairInspections" />
													</div>
												</div>
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															...
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																...
																<div class="d-flex justify-content-end">
																	<button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter" ng-click="app.list(this)">Apply</button>
																</div>
															</div>
														</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th><strong>Job Order No.</strong></th>
														<th></th>
													</tr>
												</thead>
												<tbody class="text-gray-600 fw-semibold">
													<tr ng-repeat="pri in filterData = (preRepairInspections | filter:searchpreRepairInspections) | pagination: currentPage:pageSize">
														<td><strong>{{ pri.list_no }}</strong></td>
														<td class="d-flex align-items-center">
															<div class="d-flex flex-column">
																<a class="text-gray-800 text-hover-primary mb-1">{{ pri.machinery_equipment.coa_description.account_title }}</a>
																<span>{{ pri.machinery_equipment.property_number }}</span>
															</div>
														</td>
														<td>
															<div class="badge badge-light fw-bold">{{ pri.machinery_equipment.brands.name }}</div>
														</td>
														<td>{{ pri.machinery_equipment.articles.name }}</td>
														<td>
															<div class="badge badge-light-success fw-bold">{{ pri.job_order_no }}</div>
														</td>
															...
															<div class="btn-group dropstart">
																...
																<div class="dropdown-menu menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4">
																	<div class="menu-item px-3">
																		<a href="#" class="menu-link px-3" data-kt-filemanager-table="rename" ng-click="app.viewRepairInspection(this, pri)">Pre-Repair Inspection</a>
																	</div>
																	<div class="menu-item px-3">
																		<a href="#" class="menu-link px-3" data-kt-filemanager-table="rename" ng-click="app.viewWasteMaterial(this, pri)">Waste Material</a>
																	</div>
																</div>
															</div>
														</td>
		...
		<script src="modules/pre-repair-inspection.js?ver=1.0.0.0"></script>
		<script src="controllers/pre-repair-inspection.js?ver=1.0.0.0"></script>
	</body>
</html>