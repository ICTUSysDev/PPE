...
$physical_inventory = $con->getData("SELECT * FROM physical_inventory WHERE equipment_id = $_POST[equipment_id] AND inventory_module = 'BUILDING AND OTHER STRUCTURES' ORDER BY id DESC");
