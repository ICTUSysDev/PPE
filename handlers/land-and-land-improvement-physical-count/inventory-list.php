...
$physical_inventory = $con->getData("SELECT * FROM physical_inventory WHERE equipment_id = $_POST[equipment_id] AND inventory_module = 'LAND AND LAND IMPROVEMENTS' ORDER BY id DESC");
