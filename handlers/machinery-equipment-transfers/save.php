...
$machinery_equipment_data_transfer = $_POST['machineryEquipmentDataTransfer'];
...
$check_par_number_year = $con->getData("SELECT * FROM par_number WHERE par_year = $ptr_year AND type_no = 'PAR' ORDER BY id DESC LIMIT 1");
...
// var_dump($ptr_number_incremental_result); exit();
...
if ($machinery_equipment_transfer['id']) {
	...
	$machinery_equipment_transfer['par_no'] = $par_number_incremental_result;
