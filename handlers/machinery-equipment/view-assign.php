...
$assign_to = $con->getData("SELECT id, par_id, accountable_officer, office_id, equipment_id, status IN('REASSIGN', 'PAR', 'RELOCATE', 'REPAIR', 'RETURN TO STOCK') FROM par_machinery_equipment WHERE equipment_id = $_POST[id] AND equipment_description = 'Machinery Equipment' ORDER BY id DESC LIMIT 1");
