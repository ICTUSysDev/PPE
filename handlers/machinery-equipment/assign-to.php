...
$equipment_id = $machinery_equipment['id'];
...
if($machinery_equipment['acquisition_cost']  >= 50000) {
	$form_type = 'PAR';
} else {
	$form_type = 'ICS';
}
...
// } else {
	...
	$sql = "UPDATE machinery_equipment SET status = 'Not Available' WHERE id = $equipment_id";
	$con->query($sql);
	...
	$history = array (
		...
		"module_id"=>$par_id,
		"description"=>"Assigned a Machinery/Equipment",
	...
	$notification = array (
		...
		"module_id"=>$par_id,
		"module_name"=>$form_type,
		"description"=>"Assigned a Machinery/Equipment with '.$form_type.' number - '$par_number_incremental_result'",
