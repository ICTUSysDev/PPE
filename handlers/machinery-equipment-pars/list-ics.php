...
if($user[0]['groups'] == 1 || $user[0]['groups'] == 2) {
  ...
  $machinery_equipment_pars = $con->getData("SELECT id, par_no, accountable_officer, office_id, DATE_FORMAT(par_date, '%M %d, %Y') AS par_date, form_type FROM machinery_equipment_pars WHERE form_type IN('ICS', 'TRANSFER/REASSIGN ICS')");
  ...
  $machinery_equipment_pars = $con->getData("SELECT id, par_no, accountable_officer, office_id, DATE_FORMAT(par_date, '%M %d, %Y') AS par_date, form_type FROM machinery_equipment_pars WHERE form_type IN('ICS', 'TRANSFER/REASSIGN ICS') AND  office_id = ".$user[0]['office_id']);
  ...
  $machinery_equipment_pars = $con->getData("SELECT id, par_no, accountable_officer, office_id, DATE_FORMAT(par_date, '%M %d, %Y') AS par_date, form_type FROM machinery_equipment_pars WHERE form_type IN('ICS', 'TRANSFER/REASSIGN ICS') AND accountable_officer = ".$user[0]['id']);
