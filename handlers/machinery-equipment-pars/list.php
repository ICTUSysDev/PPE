...
// print_r($machinery_equipment_pars);
  foreach($machinery_equipment_pars as $key => $machinery_equipment_par) {
    // echo $key. "<br>";
    // echo "SELECT id, par_no, accountable_officer, office_id, DATE_FORMAT(par_date, '%M %d, %Y') AS par_date, form_type FROM machinery_equipment_pars WHERE form_type NOT IN('RETURNED','DONATION', 'ICS', 'TRANSFER/REASSIGN ICS')";
    // echo "<br>";
    // print_r($machinery_equipment_pars);
    // echo "<br>";
