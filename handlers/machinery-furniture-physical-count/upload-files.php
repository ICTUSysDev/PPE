...
for($index = 0;$index < $countfiles;$index++){
  ...
  $file_generated = sprintf('Machinery-Furniture-'.'%04X%04X', mt_rand(0, 65535), mt_rand(0, 65535));
  ...
  if(isset($_FILES['files']['name'][$index]) && $_FILES['files']['name'][$index] != ''){
    ...
    $path = "../../assets/files/machinery-equipment-pi/".basename($filename, ".$ext").'-'.$file_generated.'.'.$ext;
