...
$physical_inventory = $con->getData("SELECT * FROM physical_inventory WHERE equipment_id = $_POST[equipment_id] AND inventory_module = 'MACHINERY AND EQUIPMENT' ORDER BY id DESC");
