...
for($index = 0;$index < $countfiles;$index++){
  ...
  $file_generated = sprintf('Furniture-And-Fixtures-'.'%04X%04X', mt_rand(0, 65535), mt_rand(0, 65535));
  ...
  if(isset($_FILES['files']['name'][$index]) && $_FILES['files']['name'][$index] != ''){
    ...
    $path = "../../assets/files/furniture-and-fixtures/".basename($filename, ".$ext").'-'.$file_generated.'.'.$ext;
